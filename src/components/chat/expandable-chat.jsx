...
function ExpandableChat({ className, position = "bottom-right", size = "md", icon, children, ...props }) {
...
function ExpandableChatToggle({ className, icon, isOpen, toggleChat, ...props }) {
  return (
    <Button
      variant="default"
      onClick={toggleChat}
